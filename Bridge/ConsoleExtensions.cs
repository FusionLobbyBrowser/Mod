namespace Bridge
{
...
#endif
    {
        ...
        private static readonly ReadOnlyDictionary<ConsoleColor, Color> _consoleColorLegacyMapper = new(new Dictionary<ConsoleColor, Color>
        {
        ...
        private static readonly ReadOnlyDictionary<ConsoleColor, char[]> _consoleColorMapperFg = new(new Dictionary<ConsoleColor, char[]>
        {
            ...
            [ConsoleColor.Gray] = ['3', '7'],
            [ConsoleColor.DarkGray] = ['9', '0'],
            [ConsoleColor.Red] = ['9', '1'],
            [ConsoleColor.Green] = ['9', '2'],
            [ConsoleColor.Yellow] = ['9', '3'],
            [ConsoleColor.Blue] = ['9', '4'],
            [ConsoleColor.Magenta] = ['9', '5'],
            [ConsoleColor.Cyan] = ['9', '6'],
            [ConsoleColor.White] = ['9', '7']
        });

        private static readonly ReadOnlyDictionary<ConsoleColor, char[]> _consoleColorMapperBg = new(new Dictionary<ConsoleColor, char[]>
        {
            [ConsoleColor.Black] = ['4', '0'],
            [ConsoleColor.DarkRed] = ['4', '1'],
            [ConsoleColor.DarkGreen] = ['4', '2'],
            [ConsoleColor.DarkYellow] = ['4', '3'],
            [ConsoleColor.DarkBlue] = ['4', '4'],
            [ConsoleColor.DarkMagenta] = ['4', '5'],
            [ConsoleColor.DarkCyan] = ['4', '6'],
            [ConsoleColor.Gray] = ['4', '7'],
            [ConsoleColor.DarkGray] = ['1', '0', '0'],
            [ConsoleColor.Red] = ['1', '0', '1'],
            [ConsoleColor.Green] = ['1', '0', '2'],
            [ConsoleColor.Yellow] = ['1', '0', '3'],
            [ConsoleColor.Blue] = ['1', '0', '4'],
            [ConsoleColor.Magenta] = ['1', '0', '5'],
            [ConsoleColor.Cyan] = ['1', '0', '6'],
            [ConsoleColor.White] = ['1', '0', '7']
        });
        ...
        /// <param name="input">The string to color.</param>
        /// <param name="color">The color to use on the specified string.</param>
        /// <param name="useLegacy">
        /// If <see langword="true"/>, indicates to use the fixed colour that the <see cref="ConsoleColor"/> value
        /// represents instead of its theme-defined value configured in the terminal.
        /// </param>
        ...
        /// <para>Supported format: [#]RRGGBB (case-insensitive).</para>
        /// </param>
        ...
        private static string PastelInternal(int bufferLength, in ReadOnlySpan<char> input, char colorPlaneFormatModifierInitialPart, byte r, byte rDigitCount, byte g, byte gDigitCount, byte b, byte bDigitCount, int[] colorFormatStringInsertPositions, bool addResetSuffix)
        {
            ...
            var colorFormatStringBuf = bufSpan[..i];
            var currentIndex = i;
            if (colorFormatStringInsertPositions.Length > 0)
            {
                ...
                CopySegmentToBuffer(input[previousInsertPos..], buf, ref currentIndex);
            }
            else
            {
        ...
        private static string PastelConsoleColorInternal(in ReadOnlySpan<char> input, char[] consoleColorValue)
        {
            ...
            consoleColorValue.CopyTo(bufSpan[i..]);
        ...
        {
            segment.CopyTo(destination[currentIndex..]);
