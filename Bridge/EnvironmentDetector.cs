namespace Bridge
{
    ...
    internal static class EnvironmentDetector
    {
        ...
        /// <summary>
        /// Returns <see langword="true"/> if at least one of a predefined set of environment variables are set. These
        /// environment variables could e.g. indicate that the application is running in a CI/CD environment.
        /// </summary>
        ...
        private static bool HasEnvironmentVariable()
        {
            ...
            return environmentVariables.Any(x => s_environmentVariableDetectors.Any(evd => evd(x.Key, x.Value)));
        }
    }
}